...
class WebScraper(Scraper, metaclass=SingletonMeta):
    ...
    def fetch_content(self, url):
        ...
        try:
            ...
            if 200 <= response.status_code < 300:
                ...
                self.logger.warning(
                    f"Received a non-2xx status code ({response.status_code}) from {url}"
                )
                return None
    ...
    def parse_content(self, content):
        ...
        parsed_data = {
            ...
            "content": self.content_parser.extract_content(
                soup.body
            ),  # Use ContentParser to extract content
        }
    ...
    def scrape_site(self, url):
        ...
        # Get full filepath where content was saved to ensure code execution path doesn't effect output
